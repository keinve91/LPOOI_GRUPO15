...
namespace Vistas
{
    public partial class MainForm : Form
    {
        ...
        private void InicializarMenu()
        {
            ...
            sistemaItem.Click += (s, e) => MessageBox.Show("Módulo Sistema");
            clientesItem.Click += (s, e) => MessageBox.Show("Módulo Clientes");
            prestamosItem.Click += (s, e) => MessageBox.Show("Módulo Préstamos");
        }
